...
/*
 * Minimal 8x16 bitmap font covering printable ASCII (0x20-0x7E).
 * Each glyph is 16 rows of 8 bits (MSB = leftmost pixel).
 * Non-printable entries are zeroed.
 */

const uint8_t FONT_8X16[128][FONT_HEIGHT] = {
    ...
    ['W'] = {0x00,0x00,0xC6,0xC6,0xC6,0xC6,0xC6,0xD6,0xD6,0xFE,0xEE,0x6C,0x00,0x00,0x00,0x00},
